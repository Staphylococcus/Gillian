...
"use strict";
/* P09 serializer: recursion reaches the actual leaf depth. A serializer that
   stalls at a fixed depth (< 5) would emit a truncated (valid-but-wrong) text,
   so this full-depth assertion MUST hold: it fails any fixed-bounded staller. */
var enc = JSON.stringify([1, [2, [3, [4, [5]]]]]);
var ok = enc === "[1,[2,[3,[4,[5]]]]]";
Assert(ok);
