...
"use strict";
/* P09 serializer: nested object/array composition through the actual json3.js.
   Node oracle: JSON.stringify({z:[1,{a:true}],a:null}) === '{"z":[1,{"a":true}],"a":null}' */
var enc = JSON.stringify({ z: [1, { a: true }], a: null });
var ok = enc === '{"z":[1,{"a":true}],"a":null}';
Assert(ok);
