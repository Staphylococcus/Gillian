...
"use strict";
/* P09 serializer: key order preserved as enumerated.
   Node oracle: JSON.stringify({a:1,b:2,c:3}) === '{"a":1,"b":2,"c":3}' */
var enc = JSON.stringify({ a: 1, b: 2, c: 3 });
var ok = enc === '{"a":1,"b":2,"c":3}';
Assert(ok);
