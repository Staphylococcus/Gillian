...
"use strict";
/* P09 serializer slice: JSON.stringify through the actual json3.js model on the
   reduced InitFantine init (JSON global registered). No JSON.parse.
   Node oracle: JSON.stringify({a:[1,-0]}) === '{"a":[1,0]}'  (so -0 -> "0"). */
var enc = JSON.stringify({a:[1,-0]});
var ok = enc === '{"a":[1,0]}';
Assert(ok);
