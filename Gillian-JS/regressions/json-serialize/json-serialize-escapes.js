...
"use strict";
/* P09 serializer: control-character + quote + lone-surrogate escaping.
   Input value (7 units): ", tab, LF, lone high surrogate U+D800, SOH.
   Node oracle: JSON.stringify(input) === "\"\\\"tab\\n\\ud800\\u0001\"" */
var s = "\"tab\n\ud800\u0001";
var ok = JSON.stringify(s) === "\"\\\"tab\\n\\ud800\\u0001\"";
Assert(ok);
