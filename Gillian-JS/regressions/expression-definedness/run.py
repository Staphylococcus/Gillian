...
CASES = [
    ("proof-normalize-length-required.gil", ["--total"], POST),
    ("proof-normalize-length-required.gil", ["--total", "--closed-entry", "--proc=main"], POST),
    ...
    ("proof-normalize-identity-required.gil", ["--total"], POST),
    ("proof-normalize-identity-required.gil", ["--total", "--closed-entry", "--proc=main"], POST),
