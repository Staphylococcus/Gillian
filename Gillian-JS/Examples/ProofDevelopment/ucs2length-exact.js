...
/** @id ucs2length
 ...
 @post Ucs2Prefix(#s, s-len(#s), ret) * CharCodeAtContext() * types(ret : Num) * (is-int ret) * (0 <=# ret) * (ret <=# s-len(#s))
*/
